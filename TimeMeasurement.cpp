...
void MergeSort(const vector<int>& arr) {
	...
	cout << "Time cost of MergeSort: " << (double)(end-start) << endl;//<< "Time cost of MergeSort: " 
...
void QuickSort(const vector<int>& arr) {
	...
	cout << "Time cost of QuickSort: " <<(double)(end-start) << endl;//<< "Time cost of QuickSort: "
...
void HeapSort(const vector<int>& arr) {
	...
	cout << "Time cost of HeapSort: " << (double)(end-start) << endl;//<< "Time cost of HeapSort: " 
	ofstream out("Output.txt");
	for (int i=0; i<n; i++)
		out << output[i] << ' ';
	out.close();
